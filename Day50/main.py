...
FB_EMAIL = 't93718427@gmail.com'
FB_PASSWORD = '-vwvt76%Bp6srcP'
...
email = driver.find_element(By.XPATH, value='/html/body/div/div[2]/div[1]/form/div/div[1]/div/input')
password = driver.find_element(By.XPATH, value='/html/body/div/div[2]/div[1]/form/div/div[2]/div/input')
# login = driver.find_element(By.XPATH, value='//*[@id="buttons"]/label[1]')
...
#     login.click()
#     continue1 = driver.find_element(By.XPATH,value='/html/body/div[1]/div/div/div/div/div/div/div[1]/div[3]/div/div/div/div/div/div/div[2]/div/div/div[1]/div/div/div/div[1]/div/div/div/div/div')
#     continue1.click()
# except :
#     print("Login button went stale, retrying...")
#     sleep(2)
#     print("Except")
#     login = driver.find_element(By.NAME, "login")
#     login.click()
...
cookies = driver.find_element(By.XPATH, value='/html/body/div[1]/div/div[2]/div/div/div[1]/div[2]/button/div[2]/div[2]')
cookies.click()
